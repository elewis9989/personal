        ...
        <Disclosure as="nav">
          {({ open }) => (
            <>
                    ...
                    <div className="flex items-center md:ml-6 text-black">
                      ...
                      >
                        <svg
                          ...
                          viewBox="0 0 496 512"
                          className="w-6 h-6 ml-4 hover:text-stone-400"
                        >
                          <path
                            fill="currentColor"
                      ...
                      >
                        <svg
                          ...
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="w-7 h-7 ml-4 hover:text-stone-400"
                        >
                          <path
                            strokeLinecap="round"
              ...
              <Disclosure.Panel className="md:hidden border-b-2 border-stone-600 mb-4">
