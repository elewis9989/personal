...
Wanting to build my own task manager also came at a time of wanting to build my own startup. *So*, I thought, *why not make this my first SaaS startup?* Enter [Modal](https://usemodal.com/), a SaaS productivity app designed to follow the Priority Matrix method while incorporating features from other beloved task apps like Things and Notion.
